...
impl Default for MixerTheme {
    fn default() -> Self {
        Self {
            colors: ThemeColors {
                background: Color32::from_rgb(0x1E, 0x20, 0x26),
                panel: Color32::from_rgb(0x13, 0x16, 0x1D),
                strip_bg: Color32::from_rgb(0x1B, 0x1F, 0x26),
                strip_bg_alt: Color32::from_rgb(0x17, 0x1B, 0x22),
                master_strip_bg: Color32::from_rgb(0x23, 0x28, 0x32),
                meter_background: Color32::from_rgb(0x05, 0x07, 0x0B),
                meter_low: Color32::from_rgb(0x0A, 0xD2, 0xE3),
                meter_mid: Color32::from_rgb(0x04, 0xB8, 0xD0),
                meter_high: Color32::from_rgb(0x02, 0xA1, 0xC3),
                meter_peak: Color32::from_rgb(0xF2, 0xC9, 0x4C),
                meter_clip: Color32::from_rgb(0xF6, 0x56, 0x56),
                meter_grid: Color32::from_rgb(0x28, 0x2D, 0x36),
                meter_border: Color32::from_rgb(0x3A, 0x40, 0x4A),
                text_primary: Color32::from_rgb(0xF1, 0xF4, 0xF8),
                text_dim: Color32::from_rgb(0x98, 0xA2, 0xB2),
                button_on: Color32::from_rgb(0x2C, 0x36, 0x45),
                button_off: Color32::from_rgb(0x12, 0x16, 0x1D),
                button_mute_on: Color32::from_rgb(0x1A, 0x73, 0xD9),
                button_solo_on: Color32::from_rgb(0xFF, 0xD2, 0x4F),
                button_rec_on: Color32::from_rgb(0xFF, 0x4B, 0x4B),
                button_badge: Color32::from_rgb(0x11, 0x16, 0x1E),
                rack_header: Color32::from_rgb(0xC5, 0xCC, 0xD7),
                rack_panel: Color32::from_rgb(0x16, 0x1B, 0x22),
                strip_header: Color32::from_rgb(0x0E, 0x12, 0x18),
                fader_track: Color32::from_rgb(0x0C, 0x11, 0x18),
                fader_track_inner: Color32::from_rgb(0x13, 0x19, 0x22),
                fader_handle: Color32::from_rgb(0xD6, 0xDB, 0xE3),
            },
            sizes: ThemeSizes {
                strip_width_narrow: 66.0,
                strip_width_wide: 108.0,
                fader_height: 252.0,
                fader_width: 28.0,
                meter_width: 18.0,
                knob_diameter: 32.0,
