...
impl HarmoniqPalette {
    pub fn new() -> Self {
        Self {
            ...
            mixer_strip_bg: Color32::from_rgb(32, 36, 44),
            mixer_strip_selected: Color32::from_rgb(42, 60, 86),
            mixer_strip_solo: Color32::from_rgb(40, 70, 58),
            mixer_strip_muted: Color32::from_rgb(64, 52, 56),
            mixer_strip_border: Color32::from_rgb(58, 64, 78),
            mixer_strip_header: Color32::from_rgb(34, 39, 48),
            mixer_strip_header_selected: Color32::from_rgb(46, 64, 92),
            mixer_slot_bg: Color32::from_rgb(30, 34, 42),
            mixer_slot_active: Color32::from_rgb(42, 54, 72),
            mixer_slot_border: Color32::from_rgb(58, 66, 80),
            mixer_toggle_active: Color32::from_rgb(61, 155, 243),
            mixer_toggle_inactive: Color32::from_rgb(32, 36, 44),
            mixer_toggle_text: Color32::from_rgb(232, 236, 244),
        }
    }
